# Association Interessengemeinschaft “make.human.technology”
...
According to the founders' ideas, the cooperative puts people at the centre of its activities: it serves humans and is responsible towards the cooperative members, customers, employees, suppliers, social partners, authorities and the general public. In this sense

the cooperative provides all humans with knowledge and services in the context of humans-technology-organisation;

the cooperative is committed to competitive, ethical and sustainable technology;

the cooperative is committed to the transfer of knowledge and measures for the education and training of all humans;

the cooperative sees itself as a bridge between technology and humans;

the cooperative promotes the knowledge of technology for all humans;

the cooperative is democratically organised and is committed to a structure and corporate governance that is appropriate at "eye level" and to the model of open source.  

**Art. 3
Verbindlichkeit der Werte**

These values are binding for the cooperative.  
